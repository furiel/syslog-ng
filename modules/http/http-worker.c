...
static gboolean
find_http_code_in_list(glong http_code, glong list[])
{
...
LogThreadedResult
default_1XX(HTTPDestinationWorker *self, const gchar *url, glong http_code)
{
  ...
  static glong errors[] = {100, 103, -1};
  if (find_http_code_in_list(http_code, errors))
    return LTR_ERROR;
...
LogThreadedResult
default_3XX(HTTPDestinationWorker *self, const gchar *url, glong http_code)
{
  HTTPDestinationDriver *owner = (HTTPDestinationDriver *) self->super.owner;
...
LogThreadedResult
default_4XX(HTTPDestinationWorker *self, const gchar *url, glong http_code)
{
  HTTPDestinationDriver *owner = (HTTPDestinationDriver *) self->super.owner;
  ...
  static glong errors[] = {404, 408, 409, 413, 414, 425, 428, 429, -1};
  if (find_http_code_in_list(http_code, errors))
    return LTR_ERROR;

  static glong drops[] = {410, 416, 431, 451, -1};
  if (find_http_code_in_list(http_code, drops))
    return LTR_DROP;
...
LogThreadedResult
default_5XX(HTTPDestinationWorker *self, const gchar *url, glong http_code)
{
  HTTPDestinationDriver *owner = (HTTPDestinationDriver *) self->super.owner;
  ...
  static glong errors[] = {500, 502, 503, 504, 507, -1};
  if (find_http_code_in_list(http_code, errors))
    return LTR_ERROR;
...
default_map_http_status_to_worker_status(HTTPDestinationWorker *self, const gchar *url, glong http_code)
{
  ...
  switch (http_code/100)
    {
    case 1:
      return default_1XX(self, url, http_code);
    case 2:
      /* everything is dandy */
      return  LTR_SUCCESS;
    case 3:
      return default_3XX(self, url, http_code);
    case 4:
      return default_4XX(self, url, http_code);
    case 5:
      return default_5XX(self, url, http_code);
    default:
